...
var optionsSyntax = PropTypes.arrayOf(PropTypes.shape({
  id: PropTypes.string,
...
var addressSyntax = PropTypes.shape({
  /**
...
var addressBookSyntax = PropTypes.arrayOf(addressSyntax); // alert prop type

var alertSyntax = PropTypes.shape({
  /**
...
export default {
  ...
  options: PropTypes.oneOfType([optionsSyntax, PropTypes.arrayOf(PropTypes.shape({
